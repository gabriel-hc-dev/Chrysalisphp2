...
<body class="bg-white text-gray-900">
    ...
    if (isset($_GET['id'])) {
        ...
        $sqlComentarios = "SELECT U.loginUsuario, F.nota, F.descricaoFeedback FROM Feedback F 
                           JOIN Usuario U ON F.idUsuario = U.idUsuario WHERE F.idProduto = ?";
        ...
        <div class="container mx-auto p-6">
            ...
            <div class="mt-12">
                ...
                <div class="flex justify-center space-x-2 mt-4">
                    <button onclick="filtrarComentarios(0)" class="py-2 px-4 bg-gray-200 rounded-lg hover:bg-gray-300">Todas as notas</button>
                    <?php for ($i = 1; $i <= 5; $i++) : ?>
                        <button onclick="filtrarComentarios(<?php echo $i; ?>)" class="py-2 px-4 bg-gray-200 rounded-lg hover:bg-gray-300"><?php echo $i; ?> Estrela<?php echo $i > 1 ? 's' : ''; ?></button>
                    <?php endfor; ?>
                </div>
                ...
                <div id="comentarios" class="mt-8">
                    <?php while ($comentario = $comentarios->fetch_assoc()) : ?>
                        <div class="p-4 border border-gray-300 rounded-lg mb-4">
                            ...
                            <div class="flex mb-2">
                                <?php for ($i = 0; $i < 5; $i++) : ?>
                                    <svg class="w-6 h-6 text-<?php echo $i < $comentario['nota'] ? 'orange-500' : 'gray-400'; ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                                    </svg>
                                <?php endfor; ?>
                            </div>
