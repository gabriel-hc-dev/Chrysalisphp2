        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 gap-4">
            ...
            <div class="hidden w-full lg:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col lg:flex-row lg:space-x-8 mt-4 lg:mt-0">
                    <li>
                        <a href="index.php"
                            class="block py-2 px-3 rounded lg:hover:bg-transparent text-white hover:underline hover:scale-125 active:scale-150 transition-transform duration-300">Início</a>
                    </li>
                    <li>
                        <a href="about.php"
                            class="block py-2 px-3 rounded lg:hover:bg-transparent text-white hover:underline hover:scale-125 active:scale-150 transition-transform duration-300">Sobre</a>
                    </li>
                    <li>
                        <a href="carrinho.php"
                            class="block py-2 px-3 rounded lg:hover:bg-transparent hover:scale-125 transition-transform">
